  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <Wrap href={github} label="GitHub">
        <svg viewBox="0 0 24 24" role="img" aria-hidden="true" style={dim} className={iconClass}>
      ...
      {/* Instagram (provided 50x50 path) */}
      <Wrap href={instagram} label="Instagram">
        <svg viewBox="0 0 50 50" role="img" aria-hidden="true" style={dim} className={iconClass}>
